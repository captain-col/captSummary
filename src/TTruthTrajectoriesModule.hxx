...
/// called "Trajectories" in the "TruthDir" directory of CaptainSummary files.
/// The tree contains a vector with a TTruthTrajectory for every particle in
/// the event which passes the module's criteria to be saved.  
...
/// Contains the truth information associated with a particle from Monte Carlo
/// simulations.
